...
module.exports = config => {
    ...
    const https = global.args.https ? global.args.https : process.env.APP_URL.includes('https:') && fs.existsSync(pem) ? {
    ...
    server.listen(global.args.port, process.env.APP_HOST, () => {
